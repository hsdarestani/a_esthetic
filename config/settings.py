...
MIDDLEWARE = [
    ...
    "experience_app.middleware.DeviceSessionMiddleware",
]
...
TEMPLATES = [{
    ...
    "OPTIONS": {
        "context_processors": [
            ...
            "experience_app.context_processors.integration_ui",
        ]
    },
}]
...
if APPLE_CLIENT_ID and APPLE_PRIVATE_KEY and APPLE_KEY_ID and APPLE_TEAM_ID:
    SOCIALACCOUNT_PROVIDERS["apple"] = {
        "APPS": [{
            ...
            "key": APPLE_KEY_ID,
            "settings": {"certificate_key": APPLE_PRIVATE_KEY, "team_id": APPLE_TEAM_ID},
        }],
    }
...
WEBPUSH_VAPID_SUBJECT = os.environ.get("WEBPUSH_VAPID_SUBJECT", "mailto:privacy@esthetic.smarbiz.sbs")
STRIPE_SECRET_KEY = os.environ.get("STRIPE_SECRET_KEY", "")

# Uploaded files and API payloads containing patient information must never be sent to analytics.
...
LOGGING = {
    ...
    "loggers": {
        ...
        "experience_app": {"handlers": ["console"], "level": "INFO", "propagate": False},
    },
}
